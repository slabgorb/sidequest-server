...
def _viz(visible_to, *, redact: bool = False) -> VisibilityTag:
    return VisibilityTag(
        visible_to=visible_to, perception_fidelity={},
        secrets_for=[], redact_from_narrator_canonical=redact,
    )


def _d(key: str, visible_to, *, redact: bool = False) -> SubsystemDispatch:
    return SubsystemDispatch(
        subsystem="stealth_roll_check", params={}, idempotency_key=key,
